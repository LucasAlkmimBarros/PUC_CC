...
public class CarroService {
	...
	public void makeForm(int tipo, Carro carro, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umCarro += "\t\t\t<td>Data de validade: <input class=\"input--register\" type=\"text\" name=\"dataValidade\" value=\""+ Carro.getDataValidade().toString() + "\"></td>";
			...
			umCarro += "\t\t\t<td>Data de validade: "+ carro.getDataValidade().toString() + "</td>";
			umCarro += "\t\t\t<td>&nbsp;</td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t</table>";		
		} else {
	...
	public Object insert(Request request, Response response) {
		...
		Carro carro = new Carro(-1, modelo, preco, quantidade, dataFabricacao, dataValidade);
