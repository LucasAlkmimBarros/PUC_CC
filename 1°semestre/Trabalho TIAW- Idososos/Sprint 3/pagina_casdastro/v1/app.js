...
function storeTrab(){
    var name = document.getElementById('nameTrab').value;
    var pw = document.getElementById('pwTrab').value;
    var idade = document.getElementById('idadeTrab').value;
    var telefone = document.getElementById('telefoneTrab').value;
    var email = document.getElementById('emailTrab').value;
    var emergencia = document.getElementById('emergenciaTrab').value;
    var endereco = document.getElementById('enderecoTrab').value;
    var CPF = document.getElementById('CPFTrab').value;
    var servicos = document.getElementById('servicosTrab').value;
    var carteira = document.getElementById('carteiraTrab').value;
    var lowerCaseLetters = /[a-z]/g;
    var upperCaseLetters = /[A-Z]/g;
    var numbers = /[0-9]/g;

    if(nameTrab.length == 0 || pwTrab.length == 0 || idadeTrab.length == 0 || telefoneTrab.length == 0 || emailTrab.length == 0 || emergenciaTrab.length == 0 || enderecoTrab.length == 0 || CPFTrab.length == 0 || servicosTrab.length == 0 || carteiraTrab.length == 0){
        alert('Por favor, preencha todos os campos');
...
function checkTrab(){
    ...
    var pw = document.getElementById('pwTrab').value;
    var usersTrab = JSON.parse(localStorage.getItem('usersTrab'));
    var userTrab = usersTrab.find(function(userTrab){
